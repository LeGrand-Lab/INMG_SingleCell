#!/usr/bin/env Rscript
# runs Seurat on selected subPopulations from entire seu object
# returns: respective .rds  &  two .txt markers list for each 
# --
# JohaGL
...
### running SEu for MUSC and FAPSTeno and fapsalone:
exitstatus <- sapply(names(filesrdslist), function(x){
  tryCatch({
    print("  **  "); print(filesrdslist[[x]]);print("  **  ")
